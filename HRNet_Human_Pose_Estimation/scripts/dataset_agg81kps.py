...
if __name__ == '__main__':
    infile = './lib/data/deepfashion2/annotations/train_coco.json'
    outfile = './lib/data/deepfashion2/annotations/train_coco_agg81kps.json'
    print(f'Processing training set, in:{infile}, out:{outfile}')
    agg81kps(infile, outfile)

    infile = './lib/data/deepfashion2/annotations/validation_coco.json'
    outfile = './lib/data/deepfashion2/annotations/validation_coco_agg81kps.json'
