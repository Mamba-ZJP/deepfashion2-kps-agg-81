...
def parse_args():
    ...
    parser.add_argument('--cfg',
                        ...
                        required=False,
                        type=str,
                        default='../experiments/deepfashion2/w48_512x384_adam_lr1e-3-agg81kps.yaml')
...
def main():
    ...
    checkpoint_file = './output/deepfashion2agg81kps/pose_hrnet/w48_512x384_adam_lr1e-3-agg81kps/'\
        '81kpscheckpoint.pth'
        #'81kps_epoch_8.pth'
